...
def checkout():
    ...
    return 'Order successful',render_template("checkout.html",form=form)
      
@app.route("/confirm",methods=['GET','POST'])
def orderConfirm():
    form =checkoutForm()
    if form.validate_on_submit():
        return 'Dear{},your order for {} drinks is placed successfully.'.format(form.name.data, form.total.data)
